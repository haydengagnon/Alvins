...
namespace wServer.logic.loot
{
    ...
    public static class LootTemplates
    {
        ...
        public static ILootDef[] TieredShit()
        {
            return new ILootDef[]
            {
                new Threshold(0.0001,
                    new ItemLoot("Ravenheart Sword", 0.1),
                    new ItemLoot("Wand of Death", 0.1),
                    new ItemLoot("Studded Leather Armor", 0.1),
                    new ItemLoot("Mithril Armor", 0.1),
                    new ItemLoot("Fire Dagger", 0.1),
                    new ItemLoot("Golden Bow", 0.1),
                    new ItemLoot("Robe of the Illusionist", 0.1),
                    new ItemLoot("Staff of Horror", 0.1),
                    new ItemLoot("Dragonsoul Sword", 0.1),
                    new ItemLoot("Wand of Deep Sorcery", 0.1),
                    new ItemLoot("Drake Hide Armor", 0.1),
                    new ItemLoot("Dragonscale Armor", 0.1),
                    new ItemLoot("Ragetalon Dagger", 0.1),
                    new ItemLoot("Verdant Bow", 0.1),
                    new ItemLoot("Robe of the Master", 0.1),
                    new ItemLoot("Staff of Necrotic Arcana", 0.1),
                    new ItemLoot("Staff of Diabolic Secrets", 0.1),
                    new ItemLoot("Derp Armor", 0.1),
                    new ItemLoot("Archon Sword", 0.1),
                    new ItemLoot("Wand of Shadow", 0.1),
                    new ItemLoot("Roc Leather Armor", 0.1),
                    new ItemLoot("Desolation Armor", 0.1),
                    new ItemLoot("Emeraldshard Dagger", 0.1),
                    new ItemLoot("Bow of Fey Magic", 0.1),
                    new ItemLoot("Robe of the Shadow Magus", 0.1)
        ...
        public static ILootDef[] FabledItemsLoot1()
        {
            return new ILootDef[]
            {
                ...
                new OnlyOne(
                    new ItemLoot("Kismet Seal", 0.025),
                    new ItemLoot("Soundpiercer Shuriken", 0.025),
                    new ItemLoot("Doomgrazer", 0.025),
                    new ItemLoot("Age of Zol", 0.025),
                    new ItemLoot("Wrath of Aldragine", 0.025),
                    new ItemLoot("Bane of the Vision", 0.025),
                    new ItemLoot("Spirit of the Heart", 0.025),
                    new ItemLoot("The Grand Finale", 0.025),
                    new ItemLoot("Merit of Rebellion", 0.025),
                    new ItemLoot("Enigma Wand", 0.025),
                    new ItemLoot("Spear of the Unforgiven", 0.025),
                    new ItemLoot("Dagger of Corruption", 0.025)
                ),
                //You have a 50% chance to get attack or wisdom eon
                new OnlyOne(
                    new ItemLoot("Attack Eon", 0.5),
                    new ItemLoot("Wisdom Eon", 0.5)
                ),
                ...
                new OnlyOne(
                    new ItemLoot("Medium Sacred Fragment", 0.1)
        ...
        public static ILootDef[] FabledItemsLootUltra()
        {
            return new ILootDef[]
            {
               ...
               new OnlyOne(
                    new ItemLoot("Large Sacred Fragment", 0.25)
                )
            };
        }
        ...
        public static ILootDef[] SorVeryRare()
        {
            ...
            {
                new OnlyOne(
                    new ItemLoot("Tiny Sacred Fragment", 0.0004)
                )
             };
        }
        ...
        public static ILootDef[] SorRare()
        {
            ...
            {
                new OnlyOne(
                    new ItemLoot("Tiny Sacred Fragment", 0.0003)
                )
             };
        }
        ...
        public static ILootDef[] SorUncommon()
        {
            ...
            {
                new OnlyOne(
                    new ItemLoot("Tiny Sacred Fragment", 0.0002)
                )
             };
        }
        ...
        public static ILootDef[] SorCommon()
        {
            ...
            {
                new OnlyOne(
                    new ItemLoot("Tiny Sacred Fragment", 0.0001)
                )
             };
        }
        ...
        public static ILootDef[] NFabledItemsLoot2B()
        {
            return new ILootDef[]
            {
                ...
                new OnlyOne(
                    new ItemLoot("Small Sacred Fragment", 0.1)
                )
            };
        }
        ...
        public static ILootDef[] Sor1Perc()
        {
            ...
            {
                new OnlyOne(
                    new ItemLoot("Two Tiny Sacred Fragments", 0.001),
                    new ItemLoot("Three Tiny Sacred Fragments", 0.001),
                    new ItemLoot("Tiny Sacred Fragment", 0.002)
                ),
                /*
                new OnlyOne(
        ...
        public static ILootDef[] Sor2Perc()
        {
            ...
            {
                new OnlyOne(
                    new ItemLoot("Two Tiny Sacred Fragments", 0.002),
                    new ItemLoot("Three Tiny Sacred Fragments", 0.002),
                    new ItemLoot("Tiny Sacred Fragment", 0.003)
                ),
                /*
                new OnlyOne(
                    new ItemLoot("Shine", 0.005)
        ...
        public static ILootDef[] Sor5Perc()
        {
            return new ILootDef[]
            {
                new OnlyOne(
                    new ItemLoot("Two Tiny Sacred Fragments", 0.002),
                    new ItemLoot("Three Tiny Sacred Fragments", 0.002),
                    new ItemLoot("Tiny Sacred Fragment", 0.004)
                ),
                /*
                new OnlyOne(
                    new ItemLoot("Shine", 0.005)
        ...
        public static ILootDef[] FabledItemsLootZol()
        {
            return new ILootDef[]
            {
                ...
                new OnlyOne(
                    new ItemLoot("Two Tiny Sacred Fragments", 0.05)
                )
            };
        }
        ...
        public static ILootDef[] FabledItemsLootZolUltra()
        {
            return new ILootDef[]
            {
                ...
                new OnlyOne(
                    new ItemLoot("Three Tiny Sacred Fragments", 0.05)
                )
            };
        }
    }
