    ...
    partial class BehaviorDb
    {
        ...
        //lord ruthven is waaay unfinished
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Death Tarot Card", 0.12),
                    new ItemLoot("Chasuble of Holy Light", 0.05),
                    new ItemLoot("St. Abraham's Wand", 0.05),
                    new ItemLoot("Unholy Quiver", 0.002),
                    new ItemLoot("Unholy Wand", 0.002),
                    new ItemLoot("Tome of Purification", 0.013),
                    new ItemLoot("Ring of Divine Faith", 0.05),
                    new ItemLoot("Bone Dagger", 0.15)
                    )
            )
            .Init("Hellhound",
                new State(
