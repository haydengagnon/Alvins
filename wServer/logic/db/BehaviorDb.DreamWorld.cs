        ...
        #region Boss + Objects
                    .Init("Somnus, the Dream Entity",
                      ...
                      new State("checkminions2",
                           new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                           new EntitiesNotExistsTransition(9999, "4", "Wandering Soul", "Green Parasite", "Naiad the Feared One", "The Sleepwalker", "Commander of Dreams")
                           ),
                      new State("4",
                          ...
                          new HpLessTransition(0.8, "5")
                          ),
                      new State("5",
                          new Taunt("The universe will collapse!"),
                          new Order(50, "DW Pillar", "1"),
                      ...
                      new State("7",
                          ...
                          new Order(50, "DW Pillar", "Vulnerable"),
                          new TimedTransition(1200, "8")
                          ),
                      new State("8",
                          new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                          ...
                          new EntitiesNotExistsTransition(9999, "9", "DW Pillar")
                           ),
                      new State("9",
                      ...
                      new State("19",
                          ...
                          new TossObject("DW Spawner", range: 0, angle: 0, coolDown: 99999),
                          new TossObject("DW Ground Changer 1", range: 0, angle: 0, coolDown: 99999),
           ...
           .Init("True Somnus, the Dream Entity",
              new State(
                ...
                new ItemLoot("Vial of Might", 0.1),
                new ItemLoot("Vial of Luck", 0.1),
                new ItemLoot("Vial of Restoration", 0.1),
                new ItemLoot("Vial of Protection", 0.1),
                      ...
                      new ItemLoot("Nightmare Shard", 0.002),
                      new ItemLoot("Legendary Essence", 0.0005),
                      new ItemLoot("Never Ending Nightmare", 0.0025),
                      new ItemLoot("Bottled Mercury", 0.002),
                      new ItemLoot("Subspace Slasher", 0.008),
                      new ItemLoot("Cry of the Lost Galaxies", 0.008),
                      new ItemLoot("Nanotech Charm", 0.008),
                      new ItemLoot("Quasar Hide", 0.008),
                      new ItemLoot("Cosmic Platemail", 0.008),
                      new ItemLoot("Contaminated Ring", 0.008)
                      )
            )
           ...
           .Init("DW Spawner",
            new State(
                ...
                new TransformOnDeath("Somnus Anchor"),
                new State("idle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true)
                    ),
                new State("boom",
