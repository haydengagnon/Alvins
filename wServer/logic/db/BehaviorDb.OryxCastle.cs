        ...
        private _ OryxCastle = () => Behav()
            .Init("Oryx Stone Guardian Right",
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Ancient Stone Sword", 0.06),
                    new ItemLoot("Potion of Defense", 1),
                    new ItemLoot("Gauntlet Chaos", 0.013),
            ...
            .Init("Oryx Stone Guardian Left",
                new State(
                 ...
                 new Threshold(0.1,
                    ...
                    new ItemLoot("Rusted Light Abilities Chest", 0.001),
                    new ItemLoot("Ancient Stone Sword", 0.06),
                    new ItemLoot("Gauntlet Mayhem", 0.013),
                    new ItemLoot("Potion of Defense", 1),
                    new TierLoot(8, ItemType.Weapon, 0.1),
                    new TierLoot(7, ItemType.Armor, 0.1),
                    new TierLoot(3, ItemType.Ring, 0.1)
            ...
            .Init("Oryx Insect Commander",
                new State(
                      new State("lol jordan is a nub",
                          ...
                          new Reproduce("Oryx Insect Minion", 10, 20, coolDown: 400),
