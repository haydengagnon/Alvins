    ...
    partial class BehaviorDb
    {
        ...
        //Test Chest
         .Init("lod Blue Loot Balloon",
               ...
               new MostDamagers(3,
                ...
                new ItemLoot("Rusted Robe", 0.0005),
                ...
                new ItemLoot("The World Tarot Card", 0.15)
                )
            )
        .Init("lod Green Loot Balloon",
               ...
               new MostDamagers(3,
                ...
                new TierLoot(13, ItemType.Armor, 0.05),
                new ItemLoot("Ivory Ring", 0.01),
                new ItemLoot("Rusted Leather Hide", 0.0005),
                ...
                new ItemLoot("The World Tarot Card", 0.13)
                )
            )
        .Init("lod Black Loot Balloon",
               ...
               new MostDamagers(3,
                ...
                new TierLoot(13, ItemType.Armor, 0.05),
                new ItemLoot("Ivory Ring", 0.01),
                new ItemLoot("Celestial Blade", 0.02),
                new ItemLoot("Rusted Katana", 0.0005),
        ...
        .Init("lod Red Loot Balloon",
                ...
                new TierLoot(13, ItemType.Armor, 0.05),
                new ItemLoot("Ivory Ring", 0.01),
                new ItemLoot("Rusted Platemail", 0.0005),
