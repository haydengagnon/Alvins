    ...
    partial class BehaviorDb
    {
        private _ RockDragon = () => Behav()
            .Init("Devourer of Gods",
                ...
                new ItemLoot("Legendary sparlking shiald", 1 / 500f),
                new ItemLoot("cosmos is gay", 1 / 500f),
                new ItemLoot("worm staff", 1 / 150f),
                new ItemLoot("Vexed", 1 / 150f),
                new ItemLoot("devourer of arrows", 1 / 150f),
                new ItemLoot("gem helm", 1 / 150f),
                new ItemLoot("trans pride!!!!!!!!!!", 1 / 150f),
                new ItemLoot("terrarian hide", 1 / 150f),
                new ItemLoot("5000 Fame", 1 / 1f),
                new ItemLoot("vacuum PURPLE", 1 / 150f),
                new ItemLoot("calamity gem", 1 / 150f),
