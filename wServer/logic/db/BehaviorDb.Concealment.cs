        ...
        private _ Concealment = () => Behav()
            .Init("The Dreadnought",
                ...
                new Threshold(0.022,
                    ...
                    new ItemLoot("Rusted Bow", 0.0005),
                    new ItemLoot("Rusted Medium Abilities Chest", 0.001),
                    new ItemLoot("Rally of the Dreadnought", 0.05),
                    new ItemLoot("Mythical Basilisk Venom", 0.05),
                    new ItemLoot("Bow of Dreadful Reign", 0.02)
                )
            )
          ...
          .Init("Mystical Basilisk",
           ...
           .Init("Treasure Basilisk",
                ...
                new Threshold(0.15,
                    ...
                    new ItemLoot("Lorespire Robe", 0.01)
                )
