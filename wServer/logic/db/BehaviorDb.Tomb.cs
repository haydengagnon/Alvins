            ...
            .Init("Tomb Defender",
                new State(
                    ...
                    new State("artifacts",
                        ...
                        new Reproduce("Pyramid Artifact 1", 10, 3, coolDown: 1500),
                        new Spawn("Pyramid Artifact 2", 3, 0, 3500000),
                        new Reproduce("Pyramid Artifact 2", 10, 3, coolDown: 1500),
                        new Spawn("Pyramid Artifact 3", 3, 0, 3500000),
                        new Reproduce("Pyramid Artifact 3", 10, 3, coolDown: 1500),
