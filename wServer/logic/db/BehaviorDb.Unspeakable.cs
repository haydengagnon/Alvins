...
#region servant of the dark knight (first boss)
            .Init("UNP Servant of the Dark Knight",
                ...
                new Threshold(0.025,
                    new ItemLoot("Rusted Medium Abilities Chest", 0.001),
                    new ItemLoot("Rusted Dagger", 0.0005),
                    new ItemLoot("Greater Potion of Luck", 1.0),
                    new ItemLoot("Greater Potion of Protection", 1.0),
                    ...
                    new ItemLoot("Ghilact Dagger", 0.05),
                    new ItemLoot("Wand of Parallel Distortion", 0.01),
                    new ItemLoot("Jacket of True Darkness", 0.05)
                    )
                )
...
#region the dark knight
            .Init("UNP The Dark Knight",
                ...
                new Threshold(0.11,
                    new ItemLoot("Rusted Dagger", 0.0005),
                    new ItemLoot("Rusted Medium Abilities Chest", 0.001),
                    new ItemLoot("Greater Potion of Luck", 0.2),
                    new ItemLoot("Greater Potion of Protection", 0.2),
                    new ItemLoot("Potion of Mana", 1),
                    new ItemLoot("Potion of Life", 1),
                    new ItemLoot("Night Dice", 0.005),
                    new ItemLoot("Unholy Short Sword", 0.04),
                    new ItemLoot("Unholy Bow", 0.04),
                    new ItemLoot("Unholy Dagger", 0.04),
                    new ItemLoot("Unholy Staff", 0.04),
                    new ItemLoot("Unholy Shield", 0.04),
                    new ItemLoot("Unholy Tome", 0.04),
                    new ItemLoot("Jacket of True Darkness", 0.05),
                    new ItemLoot("Broadsword of Bloodshed", 0.01),
                    new ItemLoot("Evil Shield of the Dark Knight", 0.01),
                    new ItemLoot("Amulet of the Dark Knight", 0.01),
                    new ItemLoot("Chestguard of the Underworld", 0.01),
