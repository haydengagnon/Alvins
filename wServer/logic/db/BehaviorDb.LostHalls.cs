    ...
    partial class BehaviorDb
    {
        ...
        .Init("LH Marble Colossus",
                ...
                new Threshold(0.001,
                    ...
                    new ItemLoot("chef's hat", 0.01),
                    new ItemLoot("spatula", 0.01),
                    new ItemLoot("piza piel", 1 / 500f),
                    new ItemLoot("apron chef", 0.01),
                    new ItemLoot("pizzer staff", 0.01),
                    new ItemLoot("pizza robes", 0.01),
                    new ItemLoot("dough ball hide", 1 / 500f),
                    new ItemLoot("da mop fo today", 0.01),
                    new ItemLoot("greasy pizza ring", 0.01),
                    new ItemLoot("cheese wheel seal", 0.01),
