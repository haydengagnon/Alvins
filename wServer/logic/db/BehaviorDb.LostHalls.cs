    ...
    partial class BehaviorDb
    {
        private _ LostHalls = () => Behav()
            .Init("LH Void Entity",
                ...
                new State(
                    ...
                    new State("death",
                     ...
                     new Threshold(5,
                         new ItemLoot("voidstone ring", 1 / 15000f)
                    ),
                new Threshold(0.01,
                    new ItemLoot("Onrane Cache", 1 / 100f),
                    new ItemLoot("Bow of the Void", 1 / 600f),
                    new ItemLoot("Sourcestone", 1 / 600f),
                    new ItemLoot("Armor of Nil", 1 / 600f),
                    new ItemLoot("Quiver of the Shadows", 1 / 600f),
                    new ItemLoot("treasure of the void", 1 / 350f),
                    new ItemLoot("Omnipotence Ring", 1 / 2000f),
                    new ItemLoot("Vial of Life", 0.5),
                    new ItemLoot("Vial of Defense", 0.5),
                    new ItemLoot("Vial of Attack", 0.5),
            ...
            .Init("LH Void Controller",
                new State(
                    new ConditionEffectRegion(ConditionEffectIndex.Nullified, 99),
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true),
                    new State("1",
                        new ConditionEffectRegion(ConditionEffectIndex.Nullified, 99),
                        new ChangeSize(250, 0)
            ...
            .Init("LH Void Spawner",
                new State(
                    ...
                    new State("2",
                        new Reproduce("LH Void Fragment", 3, 50, coolDown: 8000)
                        )
                    )
                )
            .Init("LH Void Split",
        ...
        .Init("LH Halls Colossus Pillar",
                new State(
                    new EntityNotExistsTransition("LH Marble Colossus", 99, "die"),
                    new State("1",
                    ...
                    new State("2",
                        new Shoot(99, 8, 45, 0, coolDown: 6200, coolDownOffset: 1000),
                    ...
                    new State("4",
                        new Shoot(99, 8, 45, 2, coolDown: 6200, coolDownOffset: 1000),
                        new TimedTransition(12000, "2", true),
                        new TimedTransition(12000, "3", true),
                        new TimedTransition(12000, "4", true),
                        new TimedTransition(12000, "5", true),
                    ...
                    new State("5",
                        new Shoot(99, 8, 45, 7, coolDown: 6200, coolDownOffset: 1000),
                        new TimedTransition(12000, "2", true),
                        new TimedTransition(12000, "3", true),
                        new TimedTransition(12000, "4", true),
                        new TimedTransition(12000, "5", true),
                    ...
                    new State("6",
                        new Shoot(99, 8, 45, 4, coolDown: 6200, coolDownOffset: 1000),
                        new TimedTransition(12000, "2", true),
                        new TimedTransition(12000, "3", true),
                        new TimedTransition(12000, "4", true),
                        new TimedTransition(12000, "5", true),
        ...
        .Init("LH Marble Colossus",
                new State(
                    ...
                    new State("21",
                        ...
                        new Shoot(99, 10, null, 14, 36, coolDown: 6000, coolDownOffset: 2800),
                        new Shoot(99, 10, null, 14, 36, coolDown: 6000, coolDownOffset: 3200),
                        new Shoot(99, 10, null, 14, 36, coolDown: 6000, coolDownOffset: 3600),
                    ...
                    new State("22",
                        ...
                        new SpiralShoot(5, 72, 3, 120, 3, coolDown: 200),
                        new Shoot(99, 3, 40, 5, coolDown: 1500),
                        new Shoot(99, 16, 22.5, 4, coolDown: 2000),
                ...
                new Threshold(0.001,
                    new ItemLoot("Legendsary Token 2", 1 / 5f),
                    new ItemLoot("5000 Fame", 1 / 50f),
                    new ItemLoot("chef's hat", 1 / 50f),
                    new ItemLoot("spatula", 1 / 50f),
                    new ItemLoot("piza piel", 1 / 250f),
                    new ItemLoot("apron chef", 1 / 50f),
                    new ItemLoot("pizzer staff", 0.01),
                    new ItemLoot("pizza robes", 0.01),
                    new ItemLoot("dough ball hide", 1 / 250f),
                    new ItemLoot("da mop fo today", 1 / 50f),
                    new ItemLoot("greasy pizza ring", 1 / 50f),
                    new ItemLoot("cheese wheel seal", 1 / 100f),
        ...
        .Init("LH Marble Defender",
                new State(
                    ...
                    new State("3",
                        ...
                        new SpiralShoot(2, 60, 16, 23, 0, coolDown: 200),
                ...
                new Threshold(0.001,
                    new ItemLoot("Unholy Helm", 0.0001)
        ...
        .Init("LH Tormented Golem",
                new State(
                    ...
                    new State("2",
                        ...
                        new Charge(3, 12, coolDown: 3000),
                        new Shoot(99, 18, 20, 0, coolDown: 1500),
                        new StayCloseToSpawn(1, 10)
                        )
                    )
                )
        ...
        .Init("LH Commander of the Crusade",
                new State(
                    ...
                    new State("2",
                        ...
                        new Shoot(12, 8, 10, 0, coolDown: 400),
        ...
        .Init("LH Greater Void Shade",
                new State(
                    ...
                    new State("1",
                        ...
                        new Shoot(99, 1, null, 5, coolDown: 1000),
                        new Shoot(9, 1, null, 0, coolDown: 400)
                        )
                    )
                )
