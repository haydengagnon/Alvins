        ...
        .Init("Tunnel Varghus the Eye",
            new State(
                ...
                new State("tp1",
                    ...
                    new Shoot(30, count: 8, shootAngle: 20, projectileIndex: 0, predictive: 0.2, coolDown: 900, coolDownOffset: 100),
            ...
            new MostDamagers(3,
                ...
                new Threshold(0.15,
                    ...
                    new TierLoot(10, ItemType.Weapon, 0.05),
                    new TierLoot(4, ItemType.Ring, 0.025),
                    new ItemLoot("Potion of Restoration", 0.6),
                    new ItemLoot("Potion of Vitality", 0.2),
                    new ItemLoot("Nightmare Shard", 0.001),
                    new ItemLoot("All-Seeing Pet Stone", 0.001),
                    new ItemLoot("Soulreaper Armor", 0.02),
                    new ItemLoot("Nether Blade", 0.01),
                    new ItemLoot("Shadow Beacon", 0.02),
                    new ItemLoot("Wand of Obscurity", 0.02),
                    new ItemLoot("Staff of Dark Malediction", 0.03),
                    new ItemLoot("Rusted Sword", 0.0005)
                )                         
        );
