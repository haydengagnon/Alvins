...
#region boss
            ...
            .Init("Murderous Megamoth",
                ...
                new Threshold(0.03,
                    ...
                    new ItemLoot("Leaf Bow", 0.02),
                    new ItemLoot("Hairy Karambit", 0.02),
                    new ItemLoot("Toad Bile Cannister", 0.02),
                    new ItemLoot("Skinned Toad Hide", 0.02),
                    new ItemLoot("Frog's Eye Ring", 0.02)
                    )
                );
#endregion boss
    }
