    ...
    partial class BehaviorDb
    {
        private _ Abyss = () => Behav()
            .Init("Archdemon Malphas",
            	...
            	new MostDamagers(3,
                	new ItemLoot("Potion of Restoration", 0.2)
                	),
            	new Threshold(0.025,
                	new OnlyOne(
                    new ItemLoot("Dagger of the Flaming Stinger", 0.05), 
                	new ItemLoot("Prism of Bright Star", 0.05),
                	new ItemLoot("Armor from the Bowels of Hell", 0.05),
                	new ItemLoot("The Ring of Flaming Power", 0.05),
                    new ItemLoot("Demon Blade", 0.05)
                        ),
                    new ItemLoot("Abysmal Whip", 0.002),
                    new ItemLoot("Fiery Bonemail", 0.0033),
                	...
                	new ItemLoot("Greater Potion of Restoration", 0.33),
