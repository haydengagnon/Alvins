        ...
        private _ Mountain = () => Behav()
            ...
            .Init("Sprite God",
                ...
                new Threshold(0.05,
                    new ItemLoot("1000 Gold", 0.005),
                    new ItemLoot("Tiny Sacred Fragment", 0.0001),
                    new ItemLoot("Dagger of Gilded Pride", 0.000004),
                    new ItemLoot("Potion of Attack", 0.06666)
                    )
            )
            ...
            new State(
                ...
                new Threshold(0.05,
                    ...
                    new OnlyOne(
                        new ItemLoot("Potion of Defense", 0.06666),
                        new ItemLoot("Potion of Attack", 0.06666),
                        new ItemLoot("Potion of Speed", 0.06666),
                        new ItemLoot("Potion of Vitality", 0.06666),
                        new ItemLoot("Potion of Wisdom", 0.06666),
                        new ItemLoot("Potion of Dexterity", 0.06666)
                        )
                    )
            )
            .Init("Sprite Child",
           ...
           .Init("Construct of the Concealment",
            ...
            .Init("Rock Bot",
                ...
                new Threshold(0.05,
                    new ItemLoot("1000 Gold", 0.001666),
                    new ItemLoot("Tiny Sacred Fragment", 0.0000333),
                    new ItemLoot("Potion of Attack", 0.005831)
                    )
            )
            .Init("Paper Bot",
                new State(
            ...
            .Init("Djinn",
                ...
                new Threshold(0.07,
                    new ItemLoot("1000 Gold", 0.005),
                    new ItemLoot("Tiny Sacred Fragment", 0.0001),
                    new ItemLoot("Ring of the Seven Seas", 0.000004),
                    new ItemLoot("Potion of Speed", 0.06666)
                    )
            )
            .Init("Leviathan",
            ...
            .Init("Lucky Djinn",
                ...
                new ItemLoot("Shalaylee", 0.02),
                new ItemLoot("Unlucky Leprechaun's Coat", 0.02),
                new ItemLoot("The Four-Leaf Seal", 0.02),
                new ItemLoot("Unlucky Leprechaun's Hat", 0.02),
