    ...
    partial class BehaviorDb
    {
        ...
        .Init("Ultra Scorching Crawler",
            ...
            new State(
                ...
                new ItemLoot("Vial of Might", 0.01),
                new ItemLoot("Vial of Luck", 0.01),
                new ItemLoot("Vial of Restoration", 0.01),
                new ItemLoot("Vial of Protection", 0.01)
                       )
            )
        ...
        .Init("Ultra Revil, the Twisted Vanguard",
                ...
                new Threshold(0.05,
                    ...
                    new ItemLoot("Sacred Fragment Cache", 0.02),
        ...
        .Init("BD Ultra Portal Spawner 2",
                ...
                new Threshold(0.05,
                    new TierLoot(7, ItemType.Ring, 0.0033),
                    new ItemLoot("Legendary Essence", 0.0005),
                    new ItemLoot("Sacred Fragment Cache", 0.03),
        ...
        .Init("BD Ultra Berikao, the Dark Hunter",
                new State(
                    new ScaleHP(0.5),
                    new DropPortalOnDeath("Ultra Twisted Trials", 1, 0),
                    new State(
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new State("default",
                        new PlayerWithinTransition(8, "taunt1")
        ...
        .Init("UltraLin2",
            ...
            .Init("Drannol, the Eternal Beast",
                ...
                new Threshold(0.005,
                    ...
                    new ItemLoot("Large Sacred Fragment", 0.006),
                    new ItemLoot("Medium Sacred Fragment", 0.015),
        ...
        .Init("Ultra Drannol, the Eternal Beast",
                ...
                new Threshold(0.004,
                    new OnlyOne(
                        new ItemLoot("Drannol's Judgement", 0.005),
                        new ItemLoot("Godly Remnant", 0.01)
                        ),
                    new ItemLoot("Bloodstone of Enmity", 0.002),
                    new ItemLoot("Legendary Essence", 0.0005),
                    new TierLoot(7, ItemType.Ring, 0.01),
                    new ItemLoot("Ultimate Onrane Cache", 0.4),
                    new ItemLoot("10000 Gold", 0.2),
                    new ItemLoot("Rusted Ring", 0.001),
                    new ItemLoot("Large Sacred Fragment", 0.01),
                    new ItemLoot("Medium Sacred Fragment", 0.033),
