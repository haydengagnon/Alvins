    ...
    partial class BehaviorDb
    {
        ...
        .Init("Earthly Pet",
           ...
           .Init("Nexus UFO Small",
            ...
            .Init("White Fountain",
                new State(
                    new HealPlayer(5, 450, 9999),
                    new HealPlayerMP(5, 450, 9999)
                )
            )
        ...
        .Init("Disco",
            new State(
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("1",
                    new GroundTransform("CGarden Floor Red", 100, persist:true),
                    new TimedTransition(100, "2")
                    ),
                new State("2",
                    new GroundTransform("CGarden Floor Blue", 100, persist: true),
                    new TimedTransition(100, "3")
                    ),
                new State("3",
                    new GroundTransform("CGarden Floor Purple", 100, persist: true),
                    new TimedTransition(100, "4")
                    ),
                new State("4",
                    new GroundTransform("CGarden Floor Yellow", 100, persist: true),
                    new TimedTransition(100, "5")
                    ),
                new State("5",
                    new GroundTransform("CGarden Floor", 100, persist: true),
        ...
        .Init("caramela",
            new State(
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("1",
                    new ReplaceTile("caramel4", "caramel5", 200),
                    new TimedTransition(450, "2")
                    ),
                new State("2",
                    new ReplaceTile("caramel5", "caramel4", 200),
                    new TimedTransition(450, "1")
                    )
                )
            )
        .Init("Cheems",
