        ...
        .Init("Anubis Statue",
              ...
              .Init("Temple Boss",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Rusted Robe", 0.01),
                    new ItemLoot("Sacred Essence", 0.004),
                    new ItemLoot("Legendary Essence", 0.004),
                    new ItemLoot("Sacred Fragment Cache", 0.20),
                    new ItemLoot("Onrane Cache", 0.20),
                    new ItemLoot("Onrane", 1.00),
                    new ItemLoot("Large Sacred Fragment", 0.10),
         ...
         .Init("Anubis Test Chest",
                ...
                new ItemLoot("Rusted Light Abilities Chest", 0.0001)//,
