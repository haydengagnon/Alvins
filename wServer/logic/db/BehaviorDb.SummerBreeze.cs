    ...
    partial class BehaviorDb
    {
        ...
        .Init("Bluey the Slime",
           ...
           .Init("Little Bluey the Slime",
            ...
            new Threshold(0.01, 
                new ItemLoot("Coconut Orb1", 0.007),
                new ItemLoot("Coconut Orb2", 0.007),
                new ItemLoot("Lifesaver", 0.007),
                new ItemLoot("Staff of the Tidal Waves", 0.01),
                new ItemLoot("Verdant Spear", 0.01),
                new ItemLoot("Sandstone Armor", 0.002)
                )
        );
    }
}