            ...
            .Init("Colothiois the Exalted",
                new State(
                 ...
                 new Threshold(0.15,
                     ...
                     new ItemLoot("Thunder and Lightning", 0.05),
                     new ItemLoot("Seal of Sky Serenade", 0.05),
            ...
            .Init("Zeus",
                 new State(
                     ...
                     new Threshold(0.025,
                         new ItemLoot("Rusted Medium Abilities Chest", 0.001),
                         new ItemLoot("Rusted Blades", 0.001),
                         new ItemLoot("Thunder and Lightning", 0.02),
                         new ItemLoot("Seal of Sky Serenade", 0.02),
                         new ItemLoot("Potion of Dexterity", 1.0),
                         new ItemLoot("Thundering Pet Stone", 0.001)
                     )
            )
            .Init("Zeus Cloud",
                   new State(
