        ...
        private _ Suffering = () => Behav()
            ...
            new State(
                ...
                new Threshold(0.001,
                    ...
                    new ItemLoot("Two Tiny Sacred Fragments", 1),
                    new ItemLoot("Onrane Cache", 1),
                    new ItemLoot("Gold Cache", 0.6),
                    new ItemLoot("Onrane", 0.5),
                    new ItemLoot("Small Sacred Fragment", 0.25),
                    new ItemLoot("Medium Sacred Fragment", 0.1),
                    new ItemLoot("Bone Axe", 0.05),
                    new ItemLoot("Malgoric Skull", 0.05),
                    new ItemLoot("Malgoric Charm", 0.05),
