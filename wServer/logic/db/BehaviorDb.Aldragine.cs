    ...
    #region bosses
        ...
        #region Ganus the Sincryer
            .Init("AH The Sincryer",
                ...
                new Threshold(0.05,
                   new ItemLoot("Onrane Cache", 0.010),
        ...
        #region The Heart
            .Init("AH The Heart",
                new State(
                    ...
                    new State("bursts",
                        ...
                        new State("ReadyBurst2",
                            ...
                            new HealAlly(999, "Beacon of Zol A", 120000),
                    ...
                    new State("Done",
                        new State(
                            ...
                            new HealAlly(999, "Beacon of Zol A", 9999999),
                ...
                new Threshold(0.05,
                    new TierLoot(7, ItemType.Ring, 0.003),
                    new ItemLoot("Rusted Sword", 0.001),
                    new ItemLoot("Rusted Staff", 0.001),
                    new ItemLoot("Rusted Wand", 0.001),
                    new ItemLoot("Rusted Dagger", 0.001),
                    new ItemLoot("Rusted Katana", 0.001),
                    new ItemLoot("Rusted Lance", 0.001),
                    new ItemLoot("Rusted Blades", 0.001),
                    new ItemLoot("Rusted Bow", 0.001),
            ...
            .Init("AH Aldragine",
                new State(
                    ...
                    new State("fight",
                        ...
                        new State("survival",
                            ...
                            new State("su golems",
                                ...
                                new State("su g spawn1",
                                    new TossObject("Corrupted Golem C", 3.5, angle: 270, coolDown: 999999),
                                ...
                                new State("su g spawn3",
                                    new TossObject("Corrupted Golem C", 3.5, angle: 90, count: 3, angleOffset: 120, coolDown: 999999),
                        ...
                        new State("stones",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable, true),
                            new State("st talk",
                                new OrderOnce(30, "Stone of Zol", "inert"),
                                new ReturnToSpawn(1, 0.5),
                ...
                new Threshold(0.05,
                    new OnlyOne(
                        ...
                        new ItemLoot("Godly Remnant", 0.001)
                        ),
                    new TierLoot(7, ItemType.Ring, 0.0033),
                    new ItemLoot("Zol Elixir", 0.0015),
            ...
            .Init("AHU Aldragine",
                new State(
                    ...
                    new State("fight",
                        ...
                        new State("fight 4",
                            new State("f4 delay",
                                new OrderOnce(30, "Stone of Zol", "invulerable"),
                                new RemoveGroup(30, "Zol Minions"),
                                new TimedTransition(800, "f4 flash")
                                ),
                            new State("f4 flash",
                ...
                new Threshold(0.05,
                    new OnlyOne(
                        new ItemLoot("Spiritclaw", 0.0020),
                        new ItemLoot("Godly Remnant", 0.0020)
                        ),
        ...
        #region Zol Cleric
            .Init("Cleric of Zol",
                new State(
                    new ScaleHP(0.2),
                    new Wander(0.6),
                    new HealGroup(10, "Zol Minions", coolDown: 6000, healAmount: 1000),
            ...
            .Init("AH Aura Controller",
                new State(
                    ...
                    new State("fast speed", // this is necessary because using Entity.TickStateManually
                        ...
                        new HealSelf(coolDown: (int)(10000 * CoreConstant.worldLogicTickMs / CoreConstant.worldTickMs)),
        ...
        #region Corrupted Golem B
            .Init("Corrupted Golem B",
                new State(
                    ...
                    new State("Main",
                        new SetAttackTarget("Beacon of Zol A"),
                        new State("fight1",
                            new Orbit(0.15, 4.13, 20),
                            new Shoot(8, count: 5, shootAngle: 20, projectileIndex: 1, coolDown: 1300, coolDownOffset: 1000),
                        ...
                        new State("fight2",
                            ...
                            new Shoot(7, count: 6, shootAngle: 10, projectileIndex: 0, coolDown: 700, coolDownOffset: 500),
                            new TimedTransition(5000, "fight1"),
                            new State("machine gun cooldown",
                                new TimedTransition(2000, "machine gun")
                                ),
                            new State("machine gun",
                                new Shoot(4, 1, projectileIndex: 2, coolDown: 200),
            ...
            .Init("Headless Corrupted Golem C",
                new State(
                    ...
                    new State("fight",
                        ...
                        new State("charge",
                            new Prioritize(
                                new Charge(1.5, 13, coolDown: 400),
                                new Wander(0.15)
                                ),
                ...
                new State(
                    new State("active",
                        ...
                        new State("spawn ultra",
                            new State("s u s1",
                                new InvisiToss("Headless Corrupted Golem C", 5, 180, count: 3, angleOffset: 120, coolDown: 9999999),
                            ...
                            new State("s u s2",
                                new InvisiToss("Headless Corrupted Golem C", 5, 0, count: 3, angleOffset: 1200, coolDown: 9999999),
                                new EntityExistsTransition("Headless Corrupted Golem C", 20, "s u w2")
                                ),
                            new State("s u w2",
                                new InvisiToss("AH Zol Incarnation", 6, angle: 0, count: 2, angleOffset: 180, coolDown: 8000, coolDownOffset: 0),
                                new InvisiToss("AH Zol Incarnation", 6, angle: 90, count: 2, angleOffset: 180, coolDown: 8000, coolDownOffset: 4000),
                            ...
                            new State("s u w3",
                                new InvisiToss("Niolru", 6, angle: 45, count: 2, angleOffset: 180, coolDown: 8000, coolDownOffset: 0),
                                new InvisiToss("Niolru", 6, angle: 135, count: 2, angleOffset: 180, coolDown: 8000, coolDownOffset: 4000),
                                new EntityNotExistsTransition("Headless Corrupted Golem C", 40, "after spawn")
                                )
                            ),
    ...
    #region Crystal of Corruption
            .Init("AH Crystal of Corruption",
                ...
                new Threshold(0.001,
                    ...
                    new ItemLoot("Vial of Attack", 0.6),
                    new ItemLoot("Vial of Wisdom", 0.6),
                    new ItemLoot("Vial of Life", 0.6),
                    new ItemLoot("Onrane Cache", 0.025),
                    new ItemLoot("10000 Gold", 0.02),
                    new ItemLoot("Ultimate Onrane Cache", 0.01),
                    new ItemLoot("Attack Eon", 0.014),
                    new ItemLoot("Wisdom Eon", 0.014),
                    new ItemLoot("Wrath of Aldragine", 0.008),
                    new ItemLoot("Age of Zol", 0.008),
                    new ItemLoot("Spirit of the Past", 0.005),
                    new ItemLoot("Essence of Corruption", 0.015),
                    new ItemLoot("Shard of Zol Corruption", 0.005),
                    new ItemLoot("Master Eon", 0.002),
                    new ItemLoot("The Zol Awakening (Crate)", 0.006),
                    //new ItemLoot("Hymns of the Zol", 0.002),
                    new ItemLoot("Godly Remnant", 0.0005)
                    )
                );
