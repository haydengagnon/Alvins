    ...
    partial class BehaviorDb
    {
        ...
        .Init("AB The Dark Sorcerer",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Bow of Revolting Wrath", 0.002),
                    new ItemLoot("1000 Gold", 0.05),
                    new ItemLoot("Onrane", 0.05),
                    new ItemLoot("Shoot Faster Potion", 0.8),
                    new ItemLoot("Dirk of Benevolence", 0.05),
                    new ItemLoot("Bow of the Lonesome Wraith", 0.05),
                    new ItemLoot("Rusted Leather Hide", 0.001),
                    new ItemLoot("Rusted Light Abilities Chest", 0.001),
                    new ItemLoot("Wand of Fractured Time", 0.1),
                    new ItemLoot("Siphon of Courage", 0.05)
                )
            )
