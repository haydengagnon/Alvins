    ...
    partial class BehaviorDb
    {
        ...
        .Init("Big Turkey God",
            ...
            new Threshold(0.01,
                    ...
                    new ItemLoot("Onrane", 0.1),
                    new ItemLoot("Onrane", 0.1),
                    new ItemLoot("Sacred Fragment Cache", 0.001),
                    new ItemLoot("Lost Scripture #1", 0.0001),
                    new ItemLoot("Lost Scripture #2", 0.0001),
                    new ItemLoot("Turkey Meal", 0.1),
                    new ItemLoot("Wand of the Pilgrimage", 0.0005),
                    new ItemLoot("The Grand Feast", 0.0005),
                    new ItemLoot("Pilgrim's Robes", 0.005),
                    new ItemLoot("The Cornucopia", 0.005),
                    new ItemLoot("Turkey Meal", 0.1),
                    new ItemLoot("Unlimited AK47", 0.0005)
                )
            )
