    ...
    partial class BehaviorDb
    {
        private _ Yazanahar = () => Behav()
            .Init("Yazanahar",
                ...
                new MostDamagers(1,
                    new ItemLoot("Life Eon", 0.1),
                    new ItemLoot("Mana Eon", 0.1)
                    ),
                new Threshold(0.01,
                    ...
                    new ItemLoot("Greater Potion of Dexterity", 0.4),
                    ...
                    new ItemLoot("Grace of the Colossus", 0.000333),
                    new ItemLoot("Extinction Shard", 0.002),
        ...
        .Init("Krokanich",
                ...
                new Threshold(0.025,
                    new ItemLoot("Rusted Light Abilities Chest", 0.001),
                    ...
                    new ItemLoot("Draketail Blade", 0.02),
                    new ItemLoot("Crashing Crescendo", 0.02)
                )
            )
         ...
         .Init("Xanarich, the Chosen One",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Chosen Bow", 0.02),
                    new ItemLoot("Quiver of the Chosen", 0.02),
                    new ItemLoot("Chosen Armor", 0.02)
                )
            )
