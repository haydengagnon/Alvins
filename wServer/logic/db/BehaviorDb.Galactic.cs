    ...
    partial class BehaviorDb
    {
        ...
        .Init("The Overseer",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Some Alien Equipment", 0.5),
                    new ItemLoot("Ieastorian Armor", 0.02),
                    new ItemLoot("Otherworldly Blades", 0.01),
                    new ItemLoot("Blade of the Nightbringer", 0.05),
                    new ItemLoot("Dire Sword", 0.05)
                )
            )
        .Init("The Alien King",
                new State(
                ...
                new Threshold(0.03,
                    ...
                    new ItemLoot("Lightsworn Axe", 0.002),
                    new ItemLoot("Greater Potion of Might", 1.0),
                    ...
                    new ItemLoot("Alikyr the Alien King's Lance", 0.01),
                    new ItemLoot("The ET Experience", 0.01),
                    new ItemLoot("Otherworldly Blades", 0.02),
                    new ItemLoot("Blade of the Nightbringer", 0.05)
                )
            )
            ;
