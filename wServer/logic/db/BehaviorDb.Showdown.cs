    ...
    partial class BehaviorDb
    {
        private _ Crimson = () => Behav()
            .Init("Hades",
                ...
                new ItemLoot("Hellish Pet Stone", 0.001),
                new ItemLoot("Scythe of the Harvester", 0.002),
                ...
                new ItemLoot("Truncheon of Immortal Demons", 0.05),
                new ItemLoot("Coat of the Devil", 0.02),
                new ItemLoot("Skull of Hades", 0.05),
                new ItemLoot("Hellslicer", 0.02),
                new ItemLoot("The Eye of Peril", 0.02),
                new ItemLoot("Sinburn Hide", 0.02),
