...
#region shtrs defense system (avatar)
            .Init("shtrs Defense System",
                ...
                new Threshold(0.05,
                    ...
                    new OnlyOne(
                        new ItemLoot("Staff of the Great Climbing", 0.19),
                        new ItemLoot("AvatarRobe", 0.02),
                        new ItemLoot("The Bloody Legacy", 0.02),
                        new ItemLoot("Tablet of the King's Avatar", 0.12),
