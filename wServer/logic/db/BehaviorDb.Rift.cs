    ...
    partial class BehaviorDb
    {
        ...
        .Init("Riv the Heavenly Champion",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Greater Potion of Protection", 0.33),
                    ...
                    new ItemLoot("Orb of Heavenly Sight", 0.06),
                    new ItemLoot("Energized Cane", 0.002),
                    new ItemLoot("Staff of Noble Magic", 0.06),
                    new ItemLoot("Heaven Monk's Apparel", 0.06),
                    new ItemLoot("Necklace of Crystalline Celestial Forces", 0.05),
                    new ItemLoot("Sheath of the Holy Revival", 0.09),
                    new ItemLoot("Spectrum Robe", 0.06),
                    new ItemLoot("Eternity Armor", 0.06),
                    new ItemLoot("Rusted Wand", 0.0005),
