    ...
    partial class BehaviorDb
    {
        ...
        .Init("Corrupted Flames of Fate",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Forsaken Shield", 0.092),
                    new ItemLoot("Sword of Dark Necromancy", 0.01),
                    new ItemLoot("Ring of Undeadly Conjury", 0.092),
        ...
        .Init("Doomages",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Blood Loss Katana", 0.002),
                    new ItemLoot("Potion of Might", 1.0),
                    new ItemLoot("Potion of Life", 1.0),
                    new ItemLoot("Potion of Wisdom", 1.0),
                    new ItemLoot("Rusted Heavy Abilities Chest", 0.001),
                    new ItemLoot("Sword of Dark Necromancy", 0.01),
                    new ItemLoot("Olden Necromancy Cloth", 0.02)
        ...
        .Init("Peppino",
                new State(
                    ...
                    new State("WanderandShoot",
                        ...
                        new TimedTransition(6500, "RunandGun")
                        ),
                     new State("RunandGun",
                         new Prioritize(
                            new Follow(0.62, 8, 1),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Dreadcull T-1", 1/10000f),
                    new ItemLoot("Sword of Dark Necromancy", 0.02),
                    new ItemLoot("Staff of the Withering", 0.015),
                    new ItemLoot("Gold Cache", 0.8),
                    
                    new ItemLoot("Necromantic Charm", 0.015),
                    new ItemLoot("Skull of Glowing Plagues", 0.015),
                    new ItemLoot("Ring of Pestilence", 0.015),
                    new ItemLoot("Tridorno's Tail", 0.005)
