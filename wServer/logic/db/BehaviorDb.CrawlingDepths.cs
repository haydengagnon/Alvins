    ...
    partial class BehaviorDb
    {
        private _ CrawlingDepths = () => Behav()
                ...
                new State(
                    ...
                    new State("4",
                        ...
                        new Wander(0.8),
                        new Follow(0.8, 10, 3, coolDown: 100),
                ...
                new Threshold(0.03,
                    ...
                    new ItemLoot("Potion of Protection", 0.3),
                    new ItemLoot("Doku No Ken", 0.005),
                    new ItemLoot("Garments of the Underground", 0.005),
                    new ItemLoot("Sheath of the Vengeful Son", 0.005),
        ...
        .Init("Crawling Red Spotted Spider",
         ...
         .Init("Red Son of Arachna Giant Egg Sac",
                ...
                new TierLoot(11, ItemType.Weapon, 0.1),
                new TierLoot(12, ItemType.Armor, 0.1),
                new ItemLoot("Stinger of the Sinful Brother", 0.01),
                new ItemLoot("Rusted Katana", 0.001)
                    ))
