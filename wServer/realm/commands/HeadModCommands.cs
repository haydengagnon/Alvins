...
namespace wServer.realm.commands
{
    public abstract class HeadModCommands
    {
        ...
        {
            public RenameCommand() : base("rename", Perms.HeadMod)
            {
            }
        ...
        {
            public GiftCommand() : base("gift", Perms.Owner)
            {
            }
            ...
            protected override bool Process(Player player, string args)
            {
                ...
                //LogToDiscord("Gift Log", $"Gift Log: [{player.Name}] has gifted [{playerName}] a [{item.DisplayName}]");
        ...
        {
            public SArenaCommand() : base("rave", Perms.HeadMod)
            {
            }
            ...
            protected override bool Process(Player player, string args)
            {
                ...
                var packet = new Text
                {
                    ...
                    TextColor = 0xFF00FF,
                    Name = "",
                    Txt = "CHIPMUNKS RAVE OPENED BY <" + player.Name + ">"
                };
