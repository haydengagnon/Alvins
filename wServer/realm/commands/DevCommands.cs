...
namespace wServer.realm.commands
{
    public abstract class DevCommands
    {
        ...
        internal class RebootCommand : Command
        {
            ...
            public void RebootServer(Player issuer, int delay, params string[] instanceIds)
            {
        ...
        {
            public SuppScoreCommand() : base("sscore", permLevel: Perms.Dev)
            {
            }
        ...
        internal class LBCCommand : Command
        {
            ...
            protected override bool Process(Player player, string args)
            {
                player.SendInfo(Program.NewItems.ToString());
                return true;
            }
        }
        ...
        {
            public WargCommand() : base("warg", Perms.Mod)
            {
            }
