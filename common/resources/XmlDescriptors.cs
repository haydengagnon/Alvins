...
namespace common.resources
{
    ...
    public class Item
    {
        ...
        public bool GodSlayer { get; }
        public bool Godly { get; }
        ...
        public bool Resurrects2 { get; }
        public bool Resurrects3 { get; }
        ...
        public KeyValuePair<int, int>[] StatsBoostInInv { get; }
        public KeyValuePair<int, int>[] StatsBoostPercInInv { get; }
        ...
        public KeyValuePair<string, int>[] EffectInv { get; }
        public bool Sacred { get; }
        public string SacredEffect { get; }
        ...
        public Item(ushort type, XElement elem)
        {
            ...
            Sacred = (elem.Element("Sacred") != null) ? true : false;

            SacredEffect = elem.Element("Sacred") != null ? elem.Element("Sacred").Attribute("id").Value : "";
            ...
            Godly = elem.Element("Godly") != null;

            GodSlayer = elem.Element("GodSlayer") != null;
            ...
            Resurrects2 = elem.Element("Resurrects2") != null;
            Resurrects3 = elem.Element("Resurrects3") != null;
            ...
            var statsInInv= new List<KeyValuePair<int, int>>();
            var statsPercInInv = new List<KeyValuePair<int, int>>();
            ...
            foreach (var i in elem.Elements("ActivateInInventory"))
            {
                var kvp = new KeyValuePair<int, int>(
                    int.Parse(i.Attribute("stat").Value),
                    int.Parse(i.Attribute("amount").Value));

                if (i.Attribute("isPerc")?.Value == "true") statsPercInInv.Add(kvp);
                else statsInInv.Add(kvp);
            }

            StatsBoost = stats.ToArray();
            StatsBoostPerc = statsPerc.ToArray();
            StatsBoostInInv = statsInInv.ToArray();
            StatsBoostPercInInv = statsPercInInv.ToArray();
            ...
            EffectInv = elem.Elements("EffectInv")
                .Select(i => new KeyValuePair<string, int>
                    (i.Attribute("effect").Value, int.Parse(i.Attribute("delay").Value))).ToArray();
        }
